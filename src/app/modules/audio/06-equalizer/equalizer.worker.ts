...
// Equalizer Worker — processes audio in background thread
...
self.onmessage = async (event: MessageEvent) => {
  ...
  try {
    ...
    // TODO: Implement equalizer audio processing logic here
    // For now: pass through using FFmpeg via postMessage
    self.postMessage({ type: 'log', message: '[equalizer] Worker started, processing...' });
