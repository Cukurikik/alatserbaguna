            ...
            <div class="flex-1 flex flex-col gap-6">
              ...
              <div class="bg-[#12121a] rounded-2xl border border-gray-800 p-6 flex flex-col gap-6 flex-1">
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <input type="range" min="-6" max="0" step="0.1" [value]="ceiling()" (input)="ceiling.set(+($event.target as HTMLInputElement).value)"
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <input type="range" min="0" max="20" step="0.5" [value]="lookahead()" (input)="lookahead.set(+($event.target as HTMLInputElement).value)"
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <input type="range" min="0.01" max="1.0" step="0.01" [value]="release()" (input)="release.set(+($event.target as HTMLInputElement).value)"
                ...
                <div class="flex flex-col gap-2">
                  ...
                  @if (targetLUFS() !== null) {
                    <input type="range" min="-23" max="-6" step="0.5" [value]="targetLUFS()!" (input)="targetLUFS.set(+($event.target as HTMLInputElement).value)"
