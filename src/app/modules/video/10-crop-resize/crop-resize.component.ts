          ...
          <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="w-full lg:w-96 flex flex-col gap-4">
              ...
              @if (vm.mode === 'crop') {
                <div class="bg-gray-800 border border-gray-700 rounded-xl p-5 flex flex-col gap-3">
                  ...
                  <div class="grid grid-cols-2 gap-3">
                    @for (field of cropFields; track field.key) {
                ...
                <div class="bg-gray-800 border border-gray-700 rounded-xl p-5 flex flex-col gap-3">
                  ...
                  <div class="grid grid-cols-3 gap-2">
                    @for (preset of scalePresets; track preset.label) {
              ...
              @if (vm.status === 'processing') {
                ...
                <button (click)="onProcess(vm)" class="w-full bg-gradient-to-r from-lime-500 to-green-500 hover:from-lime-400 hover:to-green-400 text-white font-bold py-3 rounded-xl shadow-[0_0_15px_rgba(132,204,22,0.4)] transition-all active:scale-95">
...
export class CropResizeComponent {
  ...
  dispatch(action: ReturnType<typeof CropResizeActions.setMode> | ReturnType<typeof CropResizeActions.setScale>): void {
  ...
  onProcess(state: CropResizeState): void {
