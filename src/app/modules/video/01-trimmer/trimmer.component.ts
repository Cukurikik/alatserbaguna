  ...
  template: `
    <div class="h-full w-full bg-gray-900 border border-gray-800 rounded-xl backdrop-blur-md bg-opacity-80 p-6 flex flex-col overflow-y-auto custom-scrollbar">
      ...
      <ng-container *ngIf="(state$ | async) as state">
        ...
        <!-- Upload State -->
        <div *ngIf="!state.inputFile" class="flex-1 flex flex-col justify-center">
          <app-file-drop-zone 
            accept="video/*" 
        ...
        <!-- Editor State -->
        <div *ngIf="state.inputFile" class="flex-1 flex flex-col lg:flex-row gap-6">
          ...
          <div class="w-full lg:w-96 flex flex-col gap-6">
            ...
            <div *ngIf="state.status === 'processing'" class="bg-gray-800 rounded-xl p-8 border border-gray-700 flex flex-col items-center justify-center shadow-xl">
            ...
            <!-- Success State -->
            <div *ngIf="state.status === 'success'" class="bg-gradient-to-br from-green-900/40 to-emerald-900/20 border border-green-800 rounded-xl p-6 flex flex-col items-center justify-center shadow-xl">
