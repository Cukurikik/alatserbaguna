...
@Component({
  ...
  template: `
    <div
      role="button"
      tabindex="0"
      aria-label="Drop video file here or press Enter to browse"
      class="border-2 border-dashed border-gray-600 hover:border-cyan-400 rounded-xl p-10 flex flex-col items-center justify-center cursor-pointer transition-all duration-300 bg-gray-800 bg-opacity-50 group hover:shadow-[0_0_15px_rgba(0,255,255,0.3)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
      (drop)="onDrop($event)"
